...
from PyQt6.QtWidgets import (
    ...
    QStatusBar, QLabel, QListWidget, QTextEdit, QTableWidget, QTableWidgetItem
)
...
class DemoApp(QMainWindow):
    def __init__(self):
        ...
        self.data = {
            ...
            "Stocks": """
                **S&P 500**:
                Tracks the performance of 500 large publicly traded companies in the United States.
                Known for representing the broader U.S. economy.
                ...
                **Dow Jones Industrial Average (DJIA)**:
                ...
                Represents blue-chip companies and is a narrower index compared to the S&P 500.
            """,
        }
        ...
        self.csv_files = {
            ...
            "Dow Jones Industrial Average (DJIA)": "data/summary/wikipedia_dowjones.csv",
        }
    ...
    def display_csv_in_stocks_panel(self, index_name):
        """Read the corresponding CSV file and display it in the Stocks Main Panel."""
    ...
    def mousePressEvent(self, event):
        """Override mouse press event to check for clicks on the Main Panel."""
        if self.main_panel_text.textCursor().selectedText() in self.csv_files:
            index_name = self.main_panel_text.textCursor().selectedText()
            self.display_csv_in_stocks_panel(index_name)
